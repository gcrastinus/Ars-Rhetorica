...
A claim in this application is admitted only if it was read in one of these works. Pedagogical scaffolding (the order of the acts, the wording of instructions) is the course’s own and is marked `appown`. Quotations are real and cited by author, work, and locus.

## Primary — doctrine

- **Aristotle**, *Rhetoric*, trans. W. Rhys Roberts (Oxford, 1924). Public domain. Definition (I.2); three pisteis (I.2, 1356a); three species (I.3); enthymeme and example; topics; passions (II); lexis (III).
- **Aristotle**, *Poetics*, trans. S. H. Butcher. Public domain. Metaphor.
- **Cicero**, *De inventione*, trans. C. D. Yonge. Public domain. Three genera; six parts of the oration.
- **Cicero**, *Orator* / *De oratore*, trans. Yonge. Public domain. *Docere, delectare, movere*; three styles.
- **Quintilian**, *Institutio oratoria*, trans. H. E. Butler, Loeb 1920–22. Public domain in the United States.
- **Augustine**, *De doctrina christiana* IV, trans. J. F. Shaw, NPNF I.2. Public domain. Latin: Maurist text (augustinus.it). Christian orator; three styles; Caterva. The Aquinas Institute English on augustinus.cc is **not** used.
...
- Rita Copeland and Ineke Sluiter, eds., *Medieval Grammar and Rhetoric* (Oxford, 2012) — trivium frame, not a substitute for the primary texts.
- The Blaisdell *Greek and Roman Oratory* (Dover, 2014) is used as an **authorized list of speeches**, not as a source of 2014 wording. English is taken from the public-domain translations above.
